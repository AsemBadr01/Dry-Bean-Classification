...
def perceptron_algorithm(num_epochs, learning_rate, bias_flag, feature1_value, feature2_value, classes_value):
    ...
    weights, bias = dyF.perceptron_fit(X_train, y_train, learning_rate, num_epochs, bias_flag)
